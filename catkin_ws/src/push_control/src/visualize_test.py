...
if __name__=='__main__':
    ...
    desired_traj_JSON = os.environ['PUSHING_BENCHMARK_BASE'] + '/Data/'+'8Track_point_pusher_radius_0.16_vel_0.08_3_laps.json'
    ...
    data_filename = '/home/mcube/pushing_benchmark_data/2018-05-02-11-56-178Track_point_pusher_radius_0.16_vel_0.08_3_lapsexperiments'
    ...
    for it in range(time_steps.shape[0]): #range(x_act.shape[0]):
        ...
        img = cv2.cvtColor(img,cv2.COLOR_RGB2BGR)[500:1400,500:2200] #[90:410,220:820]
