...
GPController::GPController(PusherSlider *_pusher_slider, Pusher *_line_pusher, Friction *_friction) {
...
VectorXd GPController::solveGPMPC(VectorXd xc, double time){
  ...
  //build data
//  controller->buildConstraintMatricesGPMPC(time, delta_xc);
