...
if __name__=='__main__':
    ...
    list_des_files = ['8Track_point_pusher_radius_0.15_vel_0.05_3_laps.json']
   
    list_act_files = ['8Track_point_pusher_radius_0_15_vel_0_05_infinitypoint_FOM_8track_no_perturb_R_0_01.json'] 
    # list_act_files = ['8Track_line_pusher_radius_0_15_vel_0_05_exp_infinity_fom_1.json'] 
    ...
    for counter in range(0, len(list_des_files)):
        ...
        # desired_traj_JSON = '/home/mcube/fpush/catkin_ws/src/push_control/src' + '/Data/'+ list_des_files[counter]
        ...
        # acutal_traj_JSON = '/home/mcube/fpush/catkin_ws/src/push_control/src' + '/Data/'+list_act_files[counter]
