...
def main(argv):
    ...
    while not rospy.is_shutdown():
        vizBlock([surface_data['width'][0]/2, 0, +surface_data['thickness']/2,0,0,0,1], frame_id, surface_data['color'], [surface_data['width'][0], surface_data['width'][1], surface_data['thickness']])
