#include <ros/ros.h>
#include "apc_sensor/StreamSensor.h"
#include "display.hpp"
...
private:
  ...
  std::string topic_rgb_image = "rgb/image_raw";
...
public:
  RosRealsense(): priv_nh("~"), image_transport(nh) {
    ...
    // Setup ROS service
    service_capture = nh.advertiseService("apc_sensor", &RosRealsense::srv_capture, this);
  ...
  bool srv_capture(apc_sensor::StreamSensor::Request  &req,
                   apc_sensor::StreamSensor::Response &res) {
