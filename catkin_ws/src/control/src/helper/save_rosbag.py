...
def initialize_rosbag(req):
    ...
    topics = ["/time", "/xc", "/uc", "/us", "/q_pusher_sensed", "/q_pusher_commanded", "/viewer/image_raw", "/viewer/camera_info", "/frame/track_start_frame_pub", "/frame/vicon_world_frame_pub", "/frame/viewer_frame_pub"]
...
if __name__=='__main__':
    ...
    s1 = rospy.Service('start_rosbag', Empty, initialize_rosbag)
    s2 = rospy.Service('stop_rosbag', Empty, terminate_rosbag)
    rospy.spin()
