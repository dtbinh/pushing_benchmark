function [NMSE, NLPD, Ey, Vy, mutst, diagSigmatst, atst, diagCtst, ... 
    LambdaTheta, loghyperGP, convergence, time_train] = learn_vhgpr(x_tr, y_tr, iter, loghyperGP, loghyper)
...
if nargin < 6
    ...
    loghyperGP = minimize_vhgpr(loghyperGP, 'gpr', 40, {'covSum', {'covSEardj','covNoise','covConst'}}, x_tr, y_tr);
end
