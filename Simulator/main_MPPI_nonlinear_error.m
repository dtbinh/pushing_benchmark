...
MPPI = MPPI(0.5, 0.05, 1200, .1, diag([.015,.015]), @sys.get_next_state_error_b, @sys.q_cost_nonlinear_error, @sys.phi_cost_nonlinear_error, planner.t_star, planner.xs_star, planner.us_star);
