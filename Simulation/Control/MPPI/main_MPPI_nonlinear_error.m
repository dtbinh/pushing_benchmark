...
MPPI = MPPI(1.5, 0.05, 1200, .1, diag([.0005,.005]), @sys.get_next_state_nonlinear_error_b, @sys.q_cost_nonlinear_error, @sys.phi_cost_nonlinear_error, @sys.u_constraints_nonlinear_error);
...
%     t(i)
    ...
    %
    u_bar = sys.u_constraints_nonlinear_error(x_bar', u_bar, t(i), true);
    u = u_star + u_bar;
